...
[![Backend Tests](https://github.com/jmevissen/plone-conference/actions/workflows/backend.yml/badge.svg)](https://github.com/jmevissen/plone-conference/actions/workflows/backend.yml)
[![Frontend Tests](https://github.com/jmevissen/plone-conference/actions/workflows/frontend.yml/badge.svg)](https://github.com/jmevissen/plone-conference/actions/workflows/frontend.yml)
...
```shell
git clone git@github.com:jmevissen/plone-conference.git
cd plone-conference
make install
```
...
**This was generated by [cookiecutter-plone-starter](https://github.com/collective/cookiecutter-plone-starter) on 2022-10-10 07:56:52**
